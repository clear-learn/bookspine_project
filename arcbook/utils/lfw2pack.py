...
# general
parser.add_argument('--data-dir', default='/media/yim/5ca43dd5-cbeb-4cae-aac0-e36cdd0808f7/book_side/cleansing_book/val/', help='')
parser.add_argument('--image-size', type=str, default='224, 224', help='')
parser.add_argument('--output', default='./val.bin', help='path to save.')
args = parser.parse_args()
lfw_dir = args.data_dir
image_size = [int(x) for x in args.image_size.split(',')]
lfw_pairs = lfw.read_pairs(os.path.join(lfw_dir, 'val_pairs.txt'))
