...
class CallBackVerification(object):
    ...
    def __init__(self, val_targets, rec_prefix, summary_writer=None, image_size=(224, 224), wandb_logger=None):
    ...
    def ver_test(self, backbone: torch.nn.Module, global_step: int):
        ...
        for i in range(len(self.ver_list)):
            ...
            if acc2 > self.highest_acc_list[i]:
                ...
                path_module = os.path.join("/media/yim/5ca43dd5-cbeb-4cae-aac0-e36cdd0808f7/insightface/recognition/arcface_torch/best/r100/", "model_best.pt")
            ...
            path_module = os.path.join(
                "/media/yim/5ca43dd5-cbeb-4cae-aac0-e36cdd0808f7/insightface/recognition/arcface_torch/proc/r100/",
